 ...
 */
final class Version20230405013213 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE scientist_scientist (scientist_source INT NOT NULL, scientist_target INT NOT NULL, INDEX IDX_DA303881196FBCA6 (scientist_target), INDEX IDX_DA3038818AEC29 (scientist_source), PRIMARY KEY(scientist_source, scientist_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
