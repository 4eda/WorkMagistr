 ...
 */
final class Version20230405005133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scientist ADD CONSTRAINT FK_E1774A61DB403044 FOREIGN KEY (mentor_id) REFERENCES scientist (id)');
