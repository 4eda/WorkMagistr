 ...
 */
final class Version20230406003420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student_mentor (mentor_id INT NOT NULL, student_id INT NOT NULL, INDEX IDX_E23BA5EDB403044 (mentor_id), INDEX IDX_E23BA5ECB944F1A (student_id), PRIMARY KEY(mentor_id, student_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
