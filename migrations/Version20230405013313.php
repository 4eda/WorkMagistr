 ...
 */
final class Version20230405013313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scientist_scientist ADD CONSTRAINT FK_DA3038818AEC29 FOREIGN KEY (scientist_source) REFERENCES scientist (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE scientist_scientist ADD CONSTRAINT FK_DA303881196FBCA6 FOREIGN KEY (scientist_target) REFERENCES scientist (id) ON DELETE CASCADE');
    }
